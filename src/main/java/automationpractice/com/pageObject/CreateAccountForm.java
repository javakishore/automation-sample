...
public class CreateAccountForm {
	...
	public WebElement getAccountRegisterForm() {
...
//	}
	...
	public WebElement getLastNameError() {
		return Utils.waitForElementPresence(driver, By.id("//b[contains(text(), \"lastname\")]"), 30);
	}
	...
	public WebElement getPostalCodeError() {
		return Utils.waitForElementPresence(driver, By.id("id"), 30);
	}
	...
	public WebElement getFirstNameHighlightedRed() {
		return Utils.waitForElementPresence(driver, By.xpath("customer_firstname"), 30);
	}
